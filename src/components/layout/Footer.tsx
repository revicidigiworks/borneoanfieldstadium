    ...
    <footer className="bg-[#f8fafc] border-t border-gray-200 mt-24">
        ...
        <div className="grid md:grid-cols-3 gap-14">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              Mini soccer venue dengan fasilitas modern,
              sistem keselamatan lengkap, dan komunitas
              pemain aktif yang berkembang setiap minggu.
            </p>
      ...
      <div className="border-t border-gray-200 py-6 text-center">
        ...
        <p className="text-xs text-gray-500">
          © {new Date().getFullYear()} Borneo Anfield Stadium — Keeping The Game Beautiful.
        </p>
