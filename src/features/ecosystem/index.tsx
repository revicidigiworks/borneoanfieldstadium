    ...
    <div className="flex flex-col bg-white">
      ...
      <section className="relative h-[38vh] md:h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            {t("ecosystem.hero.title1")} <br />  <span className="text-[#F6EB61]">{t("ecosystem.hero.title2")}</span>
          </motion.h1>
        </motion.div>
      </section>
          ...
          >
            ...
            <motion.div variants={fadeUp} className="md:col-span-2">
              <p className="text-gray-500 text-sm md:text-base leading-relaxed">
                {t("ecosystem.section.desc")}
              </p>

              {/* MINI POINTS */}
              <div className="flex flex-wrap gap-4 mt-6 text-[10px] md:text-xs font-bold uppercase tracking-widest text-(--primary)">
           <span>{t("ecosystem.points.community")}</span>
<span>{t("ecosystem.points.structured")}</span>
<span>{t("ecosystem.points.active")}</span>
<span>{t("ecosystem.points.growth")}</span>
              </div>
            </motion.div>
